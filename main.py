...
async def dispatch_accounts(chat_id, user_id, cost_type, context: ContextTypes.DEFAULT_TYPE):
    async with bot_lock:
        ...
        # মেথড অনুযায়ী ক্রেডিট/টাইমার ফাইনাল ডিডাক্ট
...
async def handle_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ═══════════ GUEST ACCOUNTS CLAIM LOGIC ═══════════
        ...
        if can_give:
            # স্টকে ২০০ এর কম থাকলে কনফার্মেশন জিজ্ঞাসা করা হবে
...
async def callbacks_router(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 1. USER LESS ACCOUNTS CONFIRMATION
    if data == "claim_yes":
...
def main():
    ...
    print("⚡ Bot is running with stock confirmation logic!")
